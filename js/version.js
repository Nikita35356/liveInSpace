var infoVersion = {
    ...
    "0.0.6":[["Моды","Теперь моды скачиваются нормально(раньше не было видно т. к. они быыли одинаковы)","Дополнен функционал(смотреть на <a href=\"modsWiki.html\">вики)</a>"],"Чуть-чуть изминился интерфейс","Теперь мир можно сохранить (ресурсы нет ещё))"]
}
